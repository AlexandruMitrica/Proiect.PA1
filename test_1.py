...
class Test1:
    def __init__(self, screen):
        ...
        self.player = Player((100, 100))  # Initial position, will be updated later
        ...
        # Încarcă harta Tiled
        tmx_data = load_pygame(r'E:\Python\Proiect Python V\level_1v2.tmx')
    ...
    def update(self):
        ...
        # Draw coin counter (add after drawing everything else)

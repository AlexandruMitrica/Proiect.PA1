...
class Level3:
    def __init__(self, screen):
        ...
        # Adăugăm platforme (podeaua și platforme complexe)
        platform_data = [
        ...
        # Adăugăm inamici mai puternici
        enemy = Enemy((400, 200))
        enemy2 = Enemy((700, 100))
        enemy3 = Enemy((900, 50))
        self.enemies.add(enemy, enemy2, enemy3)
        self.all_sprites.add(enemy, enemy2, enemy3)
